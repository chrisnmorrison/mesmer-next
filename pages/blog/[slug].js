          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-12">
                ...
                >
                  <div className="gridA"><h5>Date</h5>
                  <p>{frontmatter.date}</p></div>
                  
                  <div className="gridB"><h5>Category</h5>
                  <p>{frontmatter.categories}</p></div>
                  <div className="gridC"><h5 className="mt-5 mb-4">
                    Interested in a free estimate for an optimized static website?
                  </h5>
