...
!(function (a, b) {
  ...
  function e(a) {
    ...
    for (c = 1; c < arguments.length; c++) {
      ...
      for (b in g)
        f[b] =
          "object" != typeof f[b] || d(f[b]) ? f[b] || g[b] : e(f[b], g[b]);
    }
    return f;
  }
  function f(a) {
  ...
  (a.requestAnimationFrame =
    ...
    (g.prototype = {
      ...
      getScrollerHeight: function () {
        return this.scroller === a || this.scroller === b.body
    ...
    (g.cutsTheMustard =
      "undefined" != typeof h && h.rAF && h.bind && h.classList),
    (a.Headroom = g);
})(window, document);
!(function (a) {
  a &&
...
(function (a) {
  ...
  a(document).ready(function () {
    a("a, .service-item, .scroll-top").hover(
      function () {
        a(".dot").css("transform", "scale(2)");
      },
      function () {
        a(".dot").css("transform", "scale(1)");
      }
    ),
      a(".navbar").headroom(),
      ...
      a("a.page-scroll").on("click", function (b) {
        var c = a(this);
        a("html, body")
          .stop()
          .animate({ scrollTop: a(c.attr("href")).offset().top - 0 }, 800),
          b.preventDefault();
      }),
      a(".big-transform").each(function () {
        var b = TweenMax.fromTo(
            a(this),
            0.01,
            { y: 100 },
            { y: -100, ease: Power1.easeIn }
          ),
    ...
    var b = a(window);
    a('.parallex[data-type="background"]').each(function () {
      var c = a(this);
      a(window).scroll(function () {
        var a = -(b.scrollTop() / c.data("speed")),
          d = "50% " + a + "px";
        c.css({ backgroundPosition: d });
      });
    });
  }),
    ...
    a(window).on("scroll", function () {
      ...
      b >= 100 ? a("nav").addClass("nav-bg") : a("nav").removeClass("nav-bg");
    });
})(jQuery);
