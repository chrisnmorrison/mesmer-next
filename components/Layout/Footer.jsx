...
const Footer = () => {
  ...
  <div className="shape-small">
    <Image src="/images/shape-small.png" alt="small-shape" width={512} height={512} />
  </div>
      ...
      <div className="col-lg-2">
        <div className="navbar-brand" style={{marginBottom: '1.5rem', marginRight: 0}}> 
          ...
          <div className={"image-container"}>
                <Image src="/images/icon.png" className={"image img-fluid"} alt="logo" height="45" width="45"/>
              </div>
        ...
        <div className="content">
          <nav className="footer-nav nav-bg">
            <ul className="list-inline">
              ...
              <li className="list-inline-item"><Link href="/faq">FAQ</Link></li>
